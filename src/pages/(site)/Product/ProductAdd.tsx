...
const ProductAdd = () => {
  ...
  return (
    <div className="container mx-auto p-7 bg-white shadow-md rounded-lg ">
      ...
      <form>
        ...
        <div className="">
          ...
          <Button variant="outline" className="mt-2 space-x-2" onClick={() => document.getElementById('image-upload')?.click()}>
            <Upload size={18} /> 
        ...
        <Button type="submit" className="w-full bg-blue-600 text-white mt-4">Add Product</Button>
      </form>
    </div>
  )
}
